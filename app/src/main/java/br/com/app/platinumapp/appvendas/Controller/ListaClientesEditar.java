...
public class ListaClientesEditar extends AppCompatActivity implements Spinner.OnItemSelectedListener {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        mRecyclerView.addOnItemTouchListener(new RecyclerTouchListener(getApplicationContext(), mRecyclerView, new RecyclerTouchListener.ClickListener() {
            ...
            public void onClick(View view, int position) {
                ...
                Intent CadastraCliente = new Intent(getApplicationContext(), CadastraCliente.class);
                CadastraCliente.putExtra("CLI_CODIGO",cliente.getCli_codigo());
                CadastraCliente.putExtra("ALTERAR",true);
                startActivityForResult(CadastraCliente,2017);
    ...
    public void getSearch() {
        ...
        clistener = new SearchView.OnQueryTextListener() {
            ...
            public boolean onQueryTextChange(String query) {
                ...
                mClienteAdapter = new ClienteAdapter(new Cliente_SqliteDao(getApplicationContext()).getAll(query, field), ListaClientesEditar.this);
                mRecyclerView.setLayoutManager(new LinearLayoutManager(ListaClientesEditar.this));
    ...
    protected void onResume() {
        super.onResume();
        mClienteAdapter = new ClienteAdapter(new Cliente_SqliteDao(getApplicationContext()).getAll("", "cli_nome"), ListaClientesEditar.this);
        mRecyclerView.setLayoutManager(new LinearLayoutManager(ListaClientesEditar.this));
        mRecyclerView.setAdapter(mClienteAdapter);
        mClienteAdapter.notifyDataSetChanged();
    }
