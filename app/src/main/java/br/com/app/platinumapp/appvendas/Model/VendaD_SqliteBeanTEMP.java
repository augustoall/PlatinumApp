...
public class VendaD_SqliteBeanTEMP {
	...
	public VendaD_SqliteBeanTEMP() {
	}

	public VendaD_SqliteBeanTEMP(String vendad_ean, Integer vendad_codigo_produto, String vendad_descricao_produto, BigDecimal vendad_quantidade, BigDecimal vendad_precovenda, BigDecimal vendad_total) {
